...
<div class="h-screen bg-white overflow-hidden flex">
      ...
      <div
        ...
        <div class="mt-5 flex-1 h-0 overflow-y-auto">
          <nav class="px-2 space-y-1">
            ...
            <a
              href="#"
              class="bg-gray-100 text-gray-900 group rounded-md py-2 px-2 flex
            ...
            <a
              href="#"
              class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group
              rounded-md py-2 px-2 flex items-center text-base font-medium">
              <!-- Heroicon name: users -->
              <svg
            ...
            <a
              ...
              <svg
                ...
                <path
                  ...
                  2.414a1 1 0 01-.707.293h-3.172a1 1 0
  ...
  <div class="hidden md:flex md:flex-shrink-0">
    <div class="w-64 flex flex-col">
      ...
      <div
        class="border-r border-gray-200 pt-5 pb-4 flex flex-col flex-grow
        overflow-y-auto">
        <div class="flex-shrink-0 px-4 flex items-center">
          <img
            class="h-8 w-auto"
  ...
  <div class="flex-1 max-w-4xl mx-auto w-0 flex flex-col md:px-8 xl:px-0">
    <div
      class="relative z-10 flex-shrink-0 h-16 bg-white border-b border-gray-200
      flex">
      <button
        ...
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <div class="ml-3 relative">
            ...
            <div
              ...
              shadow-lg bg-white ring-1 ring-black ring-opacity-5 py-1"
              role="menu"
