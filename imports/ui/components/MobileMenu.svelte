...
<!-- {#if menuOpen} -->
<div class="md:hidden">
  <div class="inset-0 flex fixed {menuOpen ? 'z-40' : 'z-0'}">
    <!--
      ...
      -->
    <div
      class="fixed inset-0 transition-opacity ease-linear duration-500 {menuOpen ? 'opacity-100' : 'opacity-0'}">
      <div
    ...
    <!--
      ...
      -->
    <div
      class="relative flex-1 flex flex-col max-w-xs w-full bg-white transition
      ease-in-out duration-300 transform {menuOpen ? 'translate-x-0' : '-translate-x-full'}">
      <div class="absolute top-0 right-0 -mr-12 pt-2">
        <button
          on:click={toggleMenu}
          class="ml-1 flex items-center justify-center h-10 w-10 rounded-full
          focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white {menuOpen ? '' : 'hidden'}">
      ...
      <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
        ...
        <nav class="mt-5 px-2 space-y-1">
          ...
          <a
            href="#"
            class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex
            items-center px-2 py-2 text-base font-medium rounded-md">
            <!-- Heroicon name: users -->
            <svg
          ...
          <a
            ...
            <svg
              ...
              <path
                ...
                stroke-linejoin="round"
                stroke-width="2"
                d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2
                2 0 00-2 2z" />
            </svg>
            Projects
          </a>
          ...
          <a
            ...
            <svg
              ...
              <path
                ...
                2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1
                1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0
                006.586 13H4" />
            </svg>
            Documents
          </a>
      ...
      <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
        ...
        <nav class="mt-5 flex-1 px-2 bg-white space-y-1">
          ...
          <a
            href="#"
            class="bg-gray-100 text-gray-900 group flex items-center px-2 py-2
            text-sm font-medium rounded-md hover:text-gray-900 hover:bg-gray-100">
            <!-- Current: "text-gray-500", Default: "text-gray-400 group-hover:text-gray-500" -->
            <!-- Heroicon name: home -->
            <svg
